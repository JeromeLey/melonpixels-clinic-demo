...
export default function FooterCta({
  ...
  return (
    <footer className="bg-primary-900 text-white py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center px-10 py-4 bg-primary-800 hover:bg-primary-700 text-white font-semibold rounded-lg transition-colors text-lg"
        >
